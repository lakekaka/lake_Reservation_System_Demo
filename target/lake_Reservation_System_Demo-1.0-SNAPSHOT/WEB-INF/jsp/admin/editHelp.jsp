...
<form action="${pageContext.request.contextPath }/admin/editMsg" method="post">
  <div class="form-group">
    <label for="title">帮助标题</label>
    <input type="text" class="form-control" id="title" name="title" value="${help.title }">
  </div>
  <div class="form-group">
    <label for="author">填写单位</label>
    <input type="text" class="form-control" id="author" name="author" value="${help.author }">
  </div>
  <div class="form-group">
    <label for="institute">填写学院</label>
    <input type="text" class="form-control" id="institute" name="institute" value="${help.institute }">
  </div>
  <div class="form-group">
    <label for="text">文章内容</label>
    <textarea class="form-control" id="text" name="text" rows="20">${help.text }</textarea>
  </div>
